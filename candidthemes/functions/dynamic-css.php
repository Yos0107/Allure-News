...
if (!function_exists('allure_news_dynamic_css')) :
    ...
    function allure_news_dynamic_css()
    {
        ...
        if (!empty($allure_news_theme_options['allure-news-primary-color'])) {
            ...
            //background-color
            $allure_news_custom_css .= ".candid-allure-post-format, .allure-news-featured-block .allure-news-col-2 .candid-allure-post-format, .top-bar, .trending-title, .search-form input[type=submit], input[type=\"submit\"], ::selection, .breadcrumbs span.breadcrumb, article.sticky .allure-news-content-container, .candid-pagination .page-numbers.current, .candid-pagination .page-numbers:hover, .ct-title-head, .widget-title:before, .widget ul.ct-nav-tabs:before, .widget ul.ct-nav-tabs li.ct-title-head:hover, .widget ul.ct-nav-tabs li.ct-title-head.ui-tabs-active,.main-navigation ul li a:before, .main-navigation ul li.current-menu-item a:before, .cat-links a, #toTop:hover, .menu-social-menu-container .social-menu a:hover, .allure_news_widget_author ul.menu a:hover{ background-color : {$allure_news_primary_color}; }";
